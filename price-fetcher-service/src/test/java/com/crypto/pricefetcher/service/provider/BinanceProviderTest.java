...
class BinanceProviderTest {
    ...
    void setUp() {
        ...
        provider = new BinanceProvider(webClient);
    }
    ...
    void testFetchPrices_Success() {
        ...
        String jsonResponse = "{\"price\": \"45000.0\"}";
        JsonNode jsonNode;
        try {
        ...
        assertEquals(45000.0, result.get("bitcoin"));
    }

    @Test
    void testGetProviderName() {
        assertEquals(ProviderType.BINANCE, provider.getProviderName());
    }
}
